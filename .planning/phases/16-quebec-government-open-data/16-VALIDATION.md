...
| 16-03-01 | 03 | 3 | Health/MSSS curated tools | unit | `uv run pytest src/mcp_canada/modules/quebec/__tests__/test_tools.py::TestQuebecGetHealthInstallations src/mcp_canada/modules/quebec/__tests__/test_tools.py::TestQuebecGetErWaitTimes src/mcp_canada/modules/quebec/__tests__/test_tools.py::TestQuebecGetPopulationByMunicipality -x` | ✅ | ✅ green |
| 16-03-02 | 03 | 3 | MTQ transport curated tools | unit | `uv run pytest src/mcp_canada/modules/quebec/__tests__/test_tools.py::TestQuebecGetRoadConditions src/mcp_canada/modules/quebec/__tests__/test_tools.py::TestQuebecGetRoadWorks src/mcp_canada/modules/quebec/__tests__/test_tools.py::TestQuebecGetRoadEvents src/mcp_canada/modules/quebec/__tests__/test_tools.py::TestQuebecGetBridgeStructures -x` | ✅ | ✅ green |
| 16-04-01 | 04 | 4 | Environment + demographics tools | unit | `uv run pytest src/mcp_canada/modules/quebec/__tests__/test_tools.py -x -k "Air or Water or Population or Parks or Electricity or Forest"` | ✅ | ✅ green |
| 16-04-02 | 04 | 4 | 6 bilingual prompts + 7 resources | unit | `uv run pytest src/mcp_canada/modules/quebec/__tests__/test_prompts_resources.py -x` | ✅ | ✅ green |
| 16-04-03 | 04 | 4 | Integration tests via MCP Client | integration | `uv run pytest tests/integration/test_tool_scenarios.py::TestQuebecToolScenarios -m integration --timeout=120` | ✅ | ✅ green |
| 16-04-04 | 04 | 4 | Prompts/resources integration | integration | `uv run pytest tests/integration/test_prompts_resources_scenarios.py::TestQuebecPromptsResources -m integration --timeout=120` | ✅ | ✅ green |
