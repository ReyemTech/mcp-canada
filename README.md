...
| Calgary (`calgary/`) | Municipal | 5 | 2 | 1 | Socrata SODA portal, not CKAN — [Open Calgary](https://data.calgary.ca) |
| Edmonton (`edmonton/`) | Municipal | 5 | 2 | 1 | Socrata SODA portal, not CKAN — [Edmonton Open Data](https://data.edmonton.ca) |
